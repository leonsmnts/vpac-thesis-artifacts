...
1. For initial provisioning boot, create a `cloud-init disk image`, e.g. from the provided YAML files in this repository (cf. [`../vm_cloud_init/`](/vm_cloud_init/)), and uncomment the disk device.
